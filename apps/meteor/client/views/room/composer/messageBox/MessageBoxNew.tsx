...
const MessageBoxNew = ({
	...
	const isEditing = useSyncExternalStore(
		chat.composer?.editing.subscribe ?? emptySubscribe,
		chat.composer?.editing.get ?? getEmptyFalse);
	...
	{ /* New mergedRefs */}
	const newMergedRefs = useMessageComposerMergedRefs(popup.callbackRef, contentEditableRef, callbackRef, autofocusRef, keyDownHandlerCallbackRef);
